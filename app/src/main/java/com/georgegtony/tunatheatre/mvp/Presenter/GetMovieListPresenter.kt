...
class GetMovieListPresenter: BaseContract<GetMovieListContract.View>(),
    GetMovieListContract.Presenter {
    override fun getMovieList(user_id: Int, cinema_id: String, device_id: String) {
        view?.showProgressBar()
        compoundDisposable.add(
            apiService.getMovieList(user_id,device_id,cinema_id
            )
    ...
    override fun attach(view: GetMovieListContract.View) {
        super.attach(view)
